    ...
    <div class="w-full max-w-md mx-auto pb-6 px-0 sm:px-6">
      ...
      <div class="mt-4">
        ...
        <div class="relative group">
          <span class="absolute left-3 top-1/2 transform -translate-y-1/2 pointer-events-none text-gray-400 group-focus-within:text-blue-400 transition-colors duration-200" // Apply group-focus-within to the span
          >
            @
          </span>
          <input
